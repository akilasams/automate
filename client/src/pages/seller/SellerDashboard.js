...
const bull = (
  <Box
    component=""
    sx={{ display: 'inline-block', mx: '2px', transform: 'scale(0)', align : 'left'}}
  >
    •
  </Box>
...
export default function Dashboard() {
  ...
  return  (
    ...
    <Grid container spacing={20}>
      ...
      <br></br>
      <Typography component="h6" variant="h6" align="center" marginLeft="-100" style={{ color: 'black' }}> Total No. of Customers:  {countofUsers}
      </Typography>
      <br></br>
      </div>
      </Grid>
      ...
      <br></br>
      <Typography component="h6" variant="h6" align="center" marginLeft="-100" style={{ color: 'black' }}> Total No. of Ads:  {countofAds}
      </Typography>
      <br></br>
      </div>
      </Grid>
