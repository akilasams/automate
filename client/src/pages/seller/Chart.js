      ...
      <CardActionArea>
        ...
        <Typography gutterBottom variant="subtitle1" style={{fontSize: 20, color: '	#000000'}}>
            ...
            <Typography>Head Lamps</Typography>
              ...
              <Typography gutterBottom style={{fontSize: 18, color: '	#006400'}}>
            <IconButton>
               < Brightness1Icon style = {{color:'#FFA500 ', fontSize: 23 }} />
            <Typography>Ball Joint</Typography>
             </IconButton>
              </Typography>
              <Typography gutterBottom style={{fontSize: 18, color: '	#006400'}}>
            <IconButton>
               < Brightness1Icon style = {{color:'#b5b35c', fontSize: 23 }} />
            <Typography>Nuts and Bolts</Typography>
             </IconButton>
              </Typography>
              <Typography gutterBottom style={{fontSize: 18, color: '	#006400'}}>
            <IconButton>
               < Brightness1Icon style = {{color:'#d5b60a', fontSize: 23 }} />
            <Typography>Brake Hoses</Typography>
             </IconButton>
              </Typography>
              <Typography gutterBottom style={{fontSize: 18, color: '	#006400'}}>
            <IconButton>
               < Brightness1Icon style = {{color:'#24a298', fontSize: 23 }} />
            <Typography>Alternators</Typography>
             </IconButton>
              </Typography>
              <Typography gutterBottom style={{fontSize: 18, color: '	#006400'}}>
            <IconButton>
               < Brightness1Icon style = {{color:'#6fbdd3', fontSize: 23 }} />
        ...
        <Chart
          data={chartData} style={{marginLeft: '100px', marginTop : '-17%'}} >
          <PieSeries
            valueField="area"
            argumentField="Part"
          />
